...
// We do this synchronously at the top so that when we import Prisma adapters
// inside main(), we already have the right absolute path — no db.js/env.ts needed.

const envPath = resolve(__dirname, "../apps/bot/.env");
